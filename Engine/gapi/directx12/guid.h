...
template<>
inline GUID uuid<ID3D11DeviceRemovedExtendedDataSettings>(){
  return GUID{0x82BC481C, 0x6B9B, 0x4030, {0xAE, 0xDB, 0x7E, 0xE3, 0xD1, 0xDF, 0x1E, 0x63}};
  }

template<>
inline GUID uuid<ID3D11DeviceRemovedExtendedData>(){
